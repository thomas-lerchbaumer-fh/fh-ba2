...
\end{figure}
%One observation that can be made is that the final loss as well as the final MAE are almost identical to the results achieved when utilizing a single feature LSTM
