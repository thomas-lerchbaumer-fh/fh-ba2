...
Similar to the implementation of LSTM the implementation of a CNN does not require much code. Furthermore some parts of the code itself use the same parameters and is not explained again. To initialize a CNN model the following code is required: 
